...
def main():
    ...
    n_triplets_per_batch = 45  #--> n_samples / n_batches --> 15030 / 334  #------> not important, it is not used in the loss functions
...
def evaluate_embedding_space(path_save_network_model, model_dir_, deep_model, feature_space_dimension, n_res_blocks, margin_in_loss, loss_type,
    ...
    which_epoch_to_load_NN_model = 50
    batch_size_test = 100
    task_to_do = "classify"   #--> read_into_batches, embed_test_data, embed_train_data_feeding, classify, classify_top_k, query, query_from_train_set
    # k_list_in_recall = [1, 10, 100, 1000]
    # k_list_in_recall = [1, 2, 4, 8, 16]
    k_list_in_recall = [1, 3, 5]

    # path_dataset_test = "D:\\Datasets\\CRC_new_large\\CRC_100K_train_test_numpy\\test2"
    # path_dataset_test = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset\\test2"
    path_dataset_test = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset_MNIST\\test2"
    path_dataset_train = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset_MNIST\\train"
    path_save_test_patches = ".\\results\\" + deep_model + "\\batches_test2_set\\"
...
def train_embedding_space(deep_model, n_res_blocks, batch_size, learning_rate, path_save_network_model, model_dir_, feature_space_dimension, margin_in_loss, loss_type,
    ...
    path_batches = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset_MNIST\\"
    path_base_data_numpy = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset_MNIST\\train\\"
    path_base_data_numpy_val = "C:\\Users\\bghojogh\\Desktop\\code_pathology\\dataset_MNIST\\test1\\"
    #================================ 
